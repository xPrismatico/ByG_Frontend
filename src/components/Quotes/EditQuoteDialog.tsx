...
interface Props {
  quote: any; 
  disabled?: boolean; // ✅ AGREGADO: Propiedad opcional
}

export function EditQuoteDialog({ quote, disabled }: Props) { // ✅ Recibimos disabled
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* Solo renderizamos el contenido si no está deshabilitado para evitar bugs visuales */}
      {!disabled && (
